...
### 1. SSH-ключ
#### 01-vm-settings.png
![SSH-ключ](screenshots/01-ssh-keygen.png)

### 2. VPS в NetAngels
#### 02-vps.png and 03-firewall.png
![Панель NetAngels](screenshots/02-vps.png)
...
### 4. Настройка сервера
#### 05-hostname.png
![Настройка сервера](screenshots/05-hostname.png)

### 5. Пользователь student
#### 06-student.png
![user student](screenshots/06-student.png)

### 6. Git и SSH-ключ -> GitHub
#### 07-git-config__08-ssh-github.png
![Git and SSH](screenshots/07-git-config__08-ssh-github.png)
